...
const ARTICLES = [
  {
    ...
    body: [
      ...
      ['h2', "Waar het kan"],
      ['plink', "Navullen gebeurt bij hervulbare concept stores met de daarvoor bestemde apparatuur, verspreid over het land, vaak in combinatie met een salon of een winkel. Hoe zo een concept store is opgezet en hoe breed het geurenaanbod daar is, staat op <a href=\"https://www.parfumpointrefill.nl/nieuws/parfum-concept/\" rel=\"noopener\" target=\"_blank\">https://www.parfumpointrefill.nl/nieuws/parfum-concept/</a>."],
      ['h2', "Bewaren"],
